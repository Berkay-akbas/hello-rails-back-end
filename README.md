...
> This repo is for practicing rails with react in a two different App.

- [Link to the Frontend](https://github.com/Berkay-akbas/hello-react-front-end)
...
- Clone this repository with git clone`git@github.com:Berkay-akbas/hello-rails-backend` using your terminal or command line.
- Change to the project directory by entering : <br>
  `cd hello-rails-backend` in the terminal.
